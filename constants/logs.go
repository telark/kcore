...
const (
	...
	ErrFailedToFetchConfigMaps      errors.Error = "failed to fetch configmaps from namespace %s: %v"
	ErrFailedToFetchSecrets         errors.Error = "failed to fetch secrets from namespace %s: %v"
	ErrFailedToFetchIngresses       errors.Error = "failed to fetch ingresses from namespace %s: %v"
	ErrFailedToFetchNetworkPolicies errors.Error = "failed to fetch networkpolicies from namespace %s: %v"
	ErrFailedToFetchPVCs            errors.Error = "failed to fetch persistentvolumeclaims from namespace %s: %v"
	ErrFailedToGetPVC               errors.Error = "failed to get persistentvolumeclaim %s from namespace %s: %v"
	ErrPVCStorageCapacityMissing    errors.Error = "persistentvolumeclaim %s in namespace %s has no storage capacity"
	ErrFailedToFetchHPAs            errors.Error = "failed to fetch horizontalpodautoscalers from namespace %s: %v"
	ErrFailedToFetchVPAs            errors.Error = "failed to fetch verticalpodautoscalers from namespace %s: %v"
	ErrFailedToFetchServiceAccounts errors.Error = "failed to fetch serviceaccounts from namespace %s: %v"
